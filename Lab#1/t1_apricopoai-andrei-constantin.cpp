...
void Display4() {
    ...
    //difference between GL_LINE_STRIP and GL_LINES is that the last point of the previous line is the first point of the next line.
    glVertex2f(1, 1);
    glVertex2f(1, 0.80);
    glVertex2f(0.6, 0.6);
    glVertex2f(0.6, 0.40);
...
void Display5() {
    ...
    //difference between GL_LINE_LOOP and GL_LINE is that the last point of the last line is the first point of the first line => the polygon is closed
    glVertex2f(1, 1);
    glVertex2f(1, 0.80);
    glVertex2f(0.6, 0.6);
    glVertex2f(0.6, 0.40);
...
void Display7() {
    ...
    glPolygonMode(GL_FRONT, GL_FILL); // the front face of the polygon is filled
    glBegin(GL_QUADS); // the polygon is a quadrilateral
